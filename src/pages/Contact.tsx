      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <div>
          ...
          >
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-teal-50 p-3 rounded-xl text-teal-600 mr-4 shrink-0">
                    <MapPin size={24} />
                  </div>
                  <div>
                    ...
                    <a 
                      ...
                      className="text-teal-600 font-semibold text-sm mt-2 inline-flex items-center hover:text-teal-800 transition-colors"
                    >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">+91 94141 58480</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">info@drmayankameta.com</p>
                  </div>
                </div>
            ...
            {/* Google Maps Embed */}
            <div className="bg-white rounded-3xl p-2 shadow-lg border border-gray-100 h-[300px] overflow-hidden">
              <iframe 
